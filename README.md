# 🏥 AgentMed: Multi-Agent Orchestration for Multimodal Clinical AI

**AgentMed** is an open-source, fault-tolerant evaluation engine designed to benchmark frontier Vision-Language Models (VLMs) on clinical imagery. 

While the industry evaluates text-based clinical chat (e.g., OpenAI's HealthBench), AgentMed serves as the **multimodal equivalent**—evaluating spatial explainability, AI hallucination safety, and Multi-Agent consensus on high-stakes medical scans (like Diabetic Retinopathy).

You can also play with the live Multi-Agent here: https://huggingface.co/spaces/beabhinov/agentmed

---

## 🩺 For Clinical Staff & Doctors: What This Means for You
We know that AI cannot and should not replace doctors. AgentMed treats Artificial Intelligence like a **Medical Resident**, while you remain the **Attending Physician**. 
...
AgentMed is architected to solve the three major bottlenecks in enterprise AI deployment:

### 1. "Maker-Checker" Multi-Agent Orchestration
Single-shot zero-shot prompting is obsolete for high-stakes enterprise use cases. AgentMed implements a multi-agent consensus loop. 
...
1. Clone the repository:
   `git clone https://github.com/your-username/AgentMed.git`
